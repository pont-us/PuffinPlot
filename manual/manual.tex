...
\item[Suite table] is a table showing suite-level mean direction and VGP
  data. See the entry on \ppcmd{Site table} for explanations of the
  Fisher parameters associated with each mean direction. The directions
  shown are: `Site dir', the mean direction calculated from site mean
  directions; `Sample dir', the mean direction calculated from sample
  mean directions; `Site VGP', the mean of the VGPs of sites; and
