...
\item[VGP table] is a table showing virtual geomagnetic pole (VGP) data
  ...
  ellipse). VGPs can only be calculated for sites whose location has been set;
  See \emph{Import site locations\ldots} in Section~\ref{sec:menu-file} for details
  on reading site locations from a \caps{csv} file.
