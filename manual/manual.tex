...
\item[Calculations\submenu Suite means] calculates Fisherian means
  ...
  the \ppcmd{File\submenu Export Data\submenu Export suite
    calculations\ldots} menu item. Note that (like most PuffinPlot
  functions) this feature operates on all the \emph{selected} samples;
  to calculate means for the entire suite you must first select all the
  samples.
