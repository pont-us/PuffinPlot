...
\item[File\submenu Export data\submenu Export bundle\ldots] creates a
...
\item[Edit\submenu Edit sites\submenu Clear sites] removes all site names
...
\item[Edit\submenu Remove samples by depth\ldots] removes from the
  current suite all the samples outside a specified depth range.
...
\section{Creating a data bundle \label{sec:bundle}}
...
Bugra Cavdar, Jay Shah, and many others.
...
\url{http://talvi.net/puffinplot}. Bug reports, feature suggestions, and
feedback of all kinds are always very welcome. Please send them to
\textsf{\href{mailto:puffinplot@gmail.com}{puffinplot@gmail.com}}.

\subsection*{How to report a bug}

If you are reporting a bug, please be as specific as possible. Try to
