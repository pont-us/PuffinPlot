...
public class FisherValuesTest {
    ...
    public void testCalculateWithPseudorandomValues() {
        /*
         * The value of the random seed is important. It has to match the seed
         * used to generate the data from which the reference values were
         * calculated.
         */
         ...
         * random directions, so they all have very low k and high a95 compared
         * to real data sets.
         */
        ...
        /*
         * Step through the input list, slicing out chunks of increasing length
         * from 5 to 14 and calculating Fisher stats on each one.
         */
        for (int startPos = 0, sublistLength=5, resultIndex=0;
            ...
            if (expectedA95 < 180) {
                ...
                /*
                 * There's a discrepancy here between PmagPy and PuffinPlot:
                 * PmagPy sets any a95 greater than 90 to 180. I'm not sure that
                 * this is justified (neither Butler nor Borradaile mention it,
                 * and paleomagnetism.org doesn't implement it) so for now I'm
                 * keeping PuffinPlot's implementation as is and using a looser
                 * test for the 90 <= a95 <= 180 case. PmagPy also returns 180
                 * for "impossible" a95s (i.e. where the argument to acos is
                 * <-1), whereas PuffinPlot indicates this with NaN.
                 */
