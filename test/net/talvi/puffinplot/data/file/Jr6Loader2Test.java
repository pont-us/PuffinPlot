...
public class Jr6Loader2Test {
    ...
    private void checkOneFile(int fileIndex) {
        ...
        assertTrue(loadedData.getTreatmentSteps().stream().allMatch(
                d -> d.getMeasurementType() == MeasurementType.DISCRETE));

        final Suite suite = new Suite("test");
        for (TreatmentStep d: loadedData.getTreatmentSteps()) {
