 ...
 * @author pont
 */
public class TreatmentStepMomentComparator implements Comparator<TreatmentStep> {
     ...
     */
    public TreatmentStepMomentComparator(MeasurementAxis axis, Correction corr) {
        this.axis = axis;
        this.corr = corr;
